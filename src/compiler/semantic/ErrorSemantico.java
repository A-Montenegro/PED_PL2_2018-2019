...
public class ErrorSemantico {
	...
	public void lanzarErrorPorInvocacionConParametrosIncorrectos (int numeroLinea) {
		semanticErrorManager.semanticFatalError ("Error: Se ha detectado un intento de invocación de procedimiento con parámetros incorrectos (o paso por referencia incorrecto) en la línea " + numeroLinea);
	}
	 ...
	 * @param numeroLinea
	 */
	public void lanzarErrorPorProcedimientoDuplicado (int numeroLinea) {
		semanticErrorManager.semanticFatalError ("Error: Se ha detectado el intento de declarar un procedimiento con nombre repetido en la línea " + numeroLinea);
	}
	 ...
	 * @param numeroLinea
	 */
	public void lanzarErrorPorAmbitoCerradoConNombreIcorrecto (int numeroLinea) {
		semanticErrorManager.semanticFatalError ("Error: Se ha detectado que un procedimiento no se ha cerrado con el nombre correcto en la línea " + numeroLinea);
	}
	 ...
	 * @param numeroLinea
	 */
	public void lanzarErrorPorNombreSimboloEstaEnTablaTipos (int numeroLinea) {
		semanticErrorManager.semanticFatalError ("Error: Se ha detectado el intento de declaración de un símbolo cuyo nombre coincide con un tipo dentro de su ámbito en la línea " + numeroLinea);
	}
	 ...
	 * @param numeroLinea
	 */
	public void lanzarErrorPorNombreTipoEstaEnTablaSimbolos (int numeroLinea) {
		semanticErrorManager.semanticFatalError ("Error: Se ha detectado el intento de declaración de un tipo cuyo nombre coincide con un símbolo dentro de su ámbito en la línea " + numeroLinea);
	}
}
